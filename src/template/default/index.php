    ...
    <div class="col">
        <div class="d-flex" style="width: 350px;">
            <div class="me-3">
                ...
                <img style="cursor:pointer;height:100px;width:100px;" class="img-thumbnail img-fluid" src="{$vo.logo}">
                {else}
            ...
            <div class="flex-fill position-relative">
                ...
                <div class="position-absolute bottom-0 start-0">
                    ...
                    {else}
                    <a class="btn btn-sm btn-outline-success" style="cursor:pointer;" href="javascript:change('{$name}', 1);" data-bs-toggle="tooltip" title="应用运行中，点此切换">运行中...</a>
                    {if $vo['manager-url']}
                    <a class="btn btn-sm btn-outline-primary" href="{:$router->buildUrl(...$vo['manager-url'])}">管理</a>
                    {/if}
                    {/if}
                    {else}
                    ...
                    <a class="btn btn-sm btn-outline-primary" style="cursor:pointer;" href="javascript:M.open({url:'{$url}', title:'详情'});">详情</a>
                </div>
            </div>
        </div>
    </div>
